...
export async function polishSubmission({ problem, solution, timeSaved, reusableBy, editRequest }) {
  let prompt;

  if (editRequest) {
    // Re-polish with user's edit feedback
...
Apply the user's requested changes. Keep it brief and professional. Use single asterisks *bold* for bold (NOT **double**). Use Slack mrkdwn formatting.`;
  } else {
