...
// Columns: A=Team, B=Workflow, C=Tool, D=Description
...
export async function seedWorkflows(activeWorkflows) {
  ...
  try {
    ...
    const header = ['Team', 'Workflow', 'Tool', 'Description'];
    const dataRows = activeWorkflows.map(w => [w.team, w.workflow, w.tool, w.description]);
